provider "aws" {
  region     = "us-west-2"
  access_key = "AKIAZI2LIKSNMQ2PIPFT"
  secret_key = "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"
}
...
resource "google_storage_transfer_job" "s3_to_gcs" {
  ...
  transfer_spec {
    aws_s3_data_source {
      ...
      aws_access_key {
        access_key_id     = "AKIAZI2LIKSNMQ2PIPFT"
        secret_access_key = "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"
      }
    }
